...
<ul>
  <li>If the variable is equal to 5, the output will be  "The number is 5". </li>
...
<p> <a href="../../../03/pages/repetition_structures_for_and_while/README.md">Go to next content</a>  </p>
